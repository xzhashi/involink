...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variantStyles = {
    primary: 'bg-gradient-to-r from-purple-400 to-purple-700 hover:from-purple-500 hover:to-purple-800 text-white shadow-md focus:ring-purple-500 hover:shadow-lg',
